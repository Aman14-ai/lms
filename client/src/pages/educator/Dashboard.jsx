    ...
    <div className="min-h-screen flex flex-col items-start justify-between gap-8 md:p-8 p-4 pt-8 pb-0">
      <div className="flex flex-col space-y-5">
        ...
        <div className="flex flex-wrap gap-5 items-center">
          <div className="flex items-center gap-3 border border-blue-500 shadow p-4 w-56 rounded-md">
          ...
          <div className="flex items-center gap-3 border border-blue-500 shadow p-4 rounded-md">
        ...
        <div>
          <h1 className=" pb-4 text-lg font-medium">Latest Enrolments</h1>
